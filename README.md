...
Для того, чтобы закрыть курс экстерном необходимо написать мне в [личку тг](https://t.me/jussiar).

Есть два варианта:

1) показать и защитить мне готовый проект на django, в котором нам необходимо провалидировать,
